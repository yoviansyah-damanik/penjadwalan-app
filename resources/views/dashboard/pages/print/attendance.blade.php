...
@section('title', __('Print :print', ['print' => __('Attendance')]))

@section('content')
    <div class="alert alert-primary">
        <h4 class="alert-heading">{{ __('Information') }}</h4>
        <p>{{ __('The system will only load the monthly attendance.') }}</p>
    </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('print.attendance.print') }}" method="post">
                        @csrf
