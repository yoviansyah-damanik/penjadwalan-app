    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo">
                    <a href="index.html"><img src="{{ asset('dashboard-assets/images/logo/logo.png') }}" alt="Logo"
                            srcset=""></a>
                </div>
            ...
            <ul class="menu">
                ...
                <li class="sidebar-item mt-5">
                    <form class="d-block" action="{{ route('logout') }}" method="post">
                        @csrf
                        <button type="submit" class="sidebar-link w-100" style="background:transparent; border:none;">
